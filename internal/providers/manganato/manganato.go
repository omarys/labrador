...
const (
	ID             = "manganato"
	Name           = "Manganato"
	DefaultBaseURL = "https://manganato.com"
)
...
func (p *Provider) MatchesURL(rawURL string) bool {
	...
	return strings.Contains(host, "manganato.com") || strings.Contains(host, "chapmanganato.com") || strings.Contains(host, "natomanga.com")
}
